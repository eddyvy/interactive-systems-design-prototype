const INGREDIENTS = [
  { key: 'aves', name: 'Aves', color: 'warning' },
  { key: 'carnes', name: 'Carnes', color: 'error' },
  { key: 'pescados', name: 'Pescados y mariscos', color: '' },
  { key: 'arroces', name: 'Arroces', color: '' },
  { key: 'huevos', name: 'Huevos', color: 'warning' },
  { key: 'pastas', name: 'Pastas', color: 'warning' },
  { key: 'pizzas', name: 'Pizzas', color: 'error' },
  { key: 'verduras', name: 'Verduras y hortalizas', color: 'success' },
  { key: 'legumbres', name: 'Legumbres y frutos secos', color: 'warning' },
  { key: 'frutas', name: 'Frutas', color: '' },
